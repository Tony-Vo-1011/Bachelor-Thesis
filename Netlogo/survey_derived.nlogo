...
to choose-third-place-destination  ;; person procedure
  ...
  ifelse any? route-places [
    let destination one-of route-places
...
to-report rigid-visits-per-person
  if not any? people [ report 0 ]
  report mean [third-place-visits] of people with [schedule-type = "rigid"]
end

to-report medium-visits-per-person
  if not any? people [ report 0 ]
  report mean [third-place-visits] of people with [schedule-type = "medium"]
end

to-report flexible-visits-per-person
  if not any? people [ report 0 ]
  report mean [third-place-visits] of people with [schedule-type = "flexible"]
end
